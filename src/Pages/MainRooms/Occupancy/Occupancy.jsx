                        ...
                        <div className='flex-grow grid grid-cols-5'>
                            <div className='col-span-3 flex flex-col justify-around px-5'>
                                <div className='flex justify-between items-center '>
                                    <div className='flex gap-1 bg-black p-3 rounded-md text-base'>
                                ...
                                <div className='flex justify-between items-center'>
                                    <div className='bg-black p-3 rounded-md text-base'>
                            ...
                            <div className='col-span-2 bg-black rounded-md m-3 p-2'>
