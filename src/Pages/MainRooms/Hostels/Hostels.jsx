    ...
    return (
        <div className="my-2 mr-2">
            ...
            <div className="flex gap-2 mt-2">
                <p className="text-white text-sm px-5 py-3 bg-[#141414] rounded-lg flex justify-between gap-3"><span>Total Hostels</span><span>4</span></p>
                <p className="text-white text-sm px-5 py-3 bg-[#00868D] rounded-lg">+Add Hostel</p>
            </div>
            <div>
                <div className="bg-[#2e2e2e] rounded-md p-2 mt-2 grid grid-cols-10 gap-2">
                    <p className='text-white text-sm flex gap-1 col-span-10'>Hostel 1<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-right-from-square"><path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6" /><path d="m21 3-9 9" /><path d="M15 3h6v6" /></svg></p>
                    <div className="col-span-3">
                        <p className="text-[#B0B0B0] px-1 pb-2 text-sm">
                            East side of Campus, MEC,<br />
                            Mymensingh Sadar,<br />
                        ...
                        <div className="flex">
                            <p className="text-white text-base px-8 py-2 bg-[#00868D] rounded-lg">+Add Room</p>
                        </div>
                    </div>
                    <div className="col-span-7">
                        <div>
                            <div className="grid grid-cols-7 gap-2">
                                <div className="col-span-3">
                                    <div className='col-span-3 flex flex-col justify-around space-y-3'>
                                ...
                                <div className="col-span-2">
                                    <div className="bg-[#141414] p-3 rounded-md">
                                        ...
                                        <div className='w-44 p-2 mx-auto'>
                                            <CircularProgressbar
                                                value={75}
                                                text={`${75}%`}
                                                styles={buildStyles({
                            ...
                            <div>
                                <div className='flex justify-between items-center bg-[#141414] rounded-md mt-2'>
                                    <div className='p-3 text-base'>
                                        <p className='text-white'>Expected</p>
                                        <p className='text-white text-lg'>15,65,852 BDT</p>
                                    </div>
                                    <div className='p-3 text-base'>
                                        <p className='text-white'>Collected</p>
                                        <p className='text-[#00FFF5] text-lg'>3,91,463 BDT</p>
                                    </div>
                                    <div className='p-3 text-base'>
                                        <p className='text-white'>Remaining</p>
                                        <p className='text-[#FFE605] text-lg'>7,51,608 BDT</p>
                                    </div>
                                    <div className='p-3 text-base'>
                                        <p className='text-white'>Overdue</p>
                                        <p className='text-[#FFE605] text-lg'>4,85,414.12 BDT</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-[#2e2e2e] rounded-md p-2 mt-2 grid grid-cols-10 gap-2">
                    <p className='text-white text-sm flex gap-1 col-span-10'>Hostel 2<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-right-from-square"><path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6" /><path d="m21 3-9 9" /><path d="M15 3h6v6" /></svg></p>
                    <div className="col-span-3">
                        <p className="text-[#B0B0B0] px-1 pb-2 text-sm">
                            East side of Campus, MEC,<br />
                            Mymensingh Sadar,<br />
